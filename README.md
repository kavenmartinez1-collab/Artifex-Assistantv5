...
Standard OpenAI clients will ignore the `x_` fields and receive normal content. Clients that understand the extensions (like Kbot Web Suite) can render thinking blocks, tool indicators, and usage stats.
